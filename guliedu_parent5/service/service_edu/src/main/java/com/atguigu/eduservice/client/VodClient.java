...
/**
 * 在“service_edu”中只需要声明接口，也可以理解为，实质上该接口的实现类就是“service_vod”的方法（即，远程调用）
 */

/*
    @FeignClient，声明被调用的服务名
        注：value的参数是，“service_vod”模块中服务名（配置文件中的“spring.application.name=service-vod”）
